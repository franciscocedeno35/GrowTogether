							...
							<div className="backed" key={donation._id}>
								<div className="present">
									...
									<div className="info">
										...
										<h5 className="contribution">
											Total Contributed: ${donation.sum.toLocaleString('en')}
										</h5>
									</div>
								</div>
										...
										<div
											...
											<div className="rewardInfo">
												<p className="delivery" id={'delivery' + (i + 1)}>
													Delivery{' '}
													{new Date(reward.expectedDeliveryDate).toDateString()}
												</p>
												<p className="purchased" id={'purchased' + (i + 1)}>
													Purchased on{' '}
													{new Date(donation.purchaseDate).toDateString()}
												</p>
											</div>
										</div>
									);
						...
						{overviewInfo.unpublishedCampaignsOwned.map((campaign, i) => {
							return (
								<div
									...
									<img
										className="img"
										src={campaign.imageSrc ? campaign.imageSrc : ''}
									/>
									<div id="srcCamp1">
