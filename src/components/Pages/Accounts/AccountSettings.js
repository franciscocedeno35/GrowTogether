  ...
  return (
    <div className="flex-column justify-center">
      ...
      <div className="flex-row justify-center ">
        ...
        <input className="accountSetting-input" name="firstName" type="text" onChange={handleChange} defaultValue={user ? user.firstName : ""} />
      </div>
      <div className="flex-row justify-center">
        <label className="accountSetting-label">Last Name:</label>
        <input className="accountSetting-input" name="lastName" type="text" onChange={handleChange} defaultValue={user ? user.lastName : ""} />
      </div>
      <div className="flex-row justify-center">
      ...
      <div className="flex-row justify-center">
        ...
        <input className="accountSetting-input" name="password" type="text" onChange={handleChange} defaultValue={user ? user.password : ""} />
      </div>
