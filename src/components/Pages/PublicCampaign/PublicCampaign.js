...
const PublicCampaign = () => {
  const [CampInfo, setCampInfo] = useState({
    ...
    description: "Play as an artist with magic powers in this 1 vs 1 dueling game built around effect chains",
    owner: "Play as an artist with magic powers in this 1 vs 1 dueling game built around effect chains",
