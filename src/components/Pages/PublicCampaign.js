	...
	return (
		<div>
			<div className="title-section">
				<h1 className="title">{CI.title}</h1>
				<h4>{CI.subtitle}</h4>
			</div>
			<div className="intro-block">
				...
				<div className="intro-stats">
					...
					<div className="stat-block">
						<div>
							<h1 className="intro-main-stat green-highlight">${CI.currentlyDonated.toLocaleString('en')}</h1>
							<h6 className="intro-stat-label">pledged of ${CI.donateGoal.toLocaleString('en')} goal</h6>
						</div>
						<div>
